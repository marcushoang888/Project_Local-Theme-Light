export default function NavbarStore(){
    return (
        <div  className="sm:px-[15px] sm:py-[7.5px] md:px-5 lg:py-[10px] lg:px-[30px] xl:p-0 sm:flex sm:justify-between items-center">
            <a
              href=""
            ...
            >
              ...
              <div>
                <p className="sm:text-xs sm:mb-[3px]">Picking up?</p>
            ...
            >
              ...
              <div>
                <p className="sm:text-xs sm:mb-[3px]">Need delivery</p>
                <p className="sm:text-[15px] font-medium sm:pb-[3px] hover:underline">
                  See estimates
                </p>
              </div>
