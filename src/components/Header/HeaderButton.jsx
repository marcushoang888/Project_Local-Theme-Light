export default function HeaderButton() {
  return (
    <div className="flex shrink-0">
      <button
        className="sm:hidden xl:mr-[10px] xl:px-5 xl:flex xl:gap-3 xl:items-center xl:border-[1px] xl:border-solid xl:border-[#1d1d1d] xl:rounded-full xl:text-base xl:leading-4 xl:font-medium hover:bg-black hover:text-white"
        href=""
      >
        <svg
