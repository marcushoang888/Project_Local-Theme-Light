  ...
  return (
    <header>
      ...
      <div className=" border-b-[1px] border-solid border-gray">
        {/* Header container */}
        <div className="sm:flex sm:flex-col xl:flex-row">
          <div className="sm:px-[15px] sm:py-[15px] md:px-5  lg:px-[30px] lg:py-5 sm:flex sm:justify-between sm:items-center ">
            {/* Header menu */}
            ...
            {/* Header account btn  */}
            <button className="block sm:hidden xl:flex xl:items-center border-[1px] xl:border-solid xl:border-[#1d1d1d] xl:rounded-full xl:mr-[10px] xl:pl-[53px] xl:pr-5" href="">
              <svg
                width={22}
                height={22}
                viewBox="0 0 22 22"
            ...
            <button className="block sm:flex sm:relative xl:bg-[#1d1d1d] xl:flex xl:justify- xl:items-center xl:rounded-full xl:mr-[10px] xl:pl-[53px] xl:pr-5 xl:text-white" href="">
              <svg
                className="sm:stroke-black xl:stroke-white"
                width={22}
                height={22}
                viewBox="0 0 22 22"
                fill="none"
          ...
          {/* Header search box */}
          <div className="relative sm:px-[15px] sm:pb-[15px] md:px-5 lg:px-[30px] lg:pb-5 flex items-center ">
            <input
            ...
            />
            {/* <div className="absolute left-0 top-0 bottom-0 w-screen h-screen bg-[#1d1d1d] opacity-30"></div> */}
            <span className="absolute left-0 translate-x-[35px]">
              <svg
                width={22}
                height={22}
                viewBox="0 0 22 22"
